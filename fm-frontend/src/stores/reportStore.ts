...
//   getReportCollection,
//   getReportAction,
//   getReportProcessTable,
//   getReportCollectionTable,
//   getReportGroupsTable,
//   getReportActionTable,
//   getReportProcessDetail,
//   getReportCollectionDetail,
//   getReportGroupDetail,
//   getCompanyReport,
...
// import { IReportCollectionTable } from 'interfaces/collection'
import { IReportProcessTable } from 'interfaces/process'
import { PaginationList } from 'interfaces'
import { getCompanyReport, getCompanyReportDetail, getCompanyReportTable } from 'API/report'
...
class ReportStore {
  ...
  public async getReportGeneralInformation(organizationId: string, payload: IReportGeneralPayload): Promise<void> {
  ...
  public async getReportProcess(organizationId: string, payload: IReportProcessPayload): Promise<void> {
    // const reportProcess = await getReportProcess(organizationId, payload)
    // this.reportProcess = reportProcess
  }

  public async getReportProcessTable(organizationId: string, payload: IReportProcessPayload): Promise<void> {
    // const reportProcessTable = await getReportProcessTable(organizationId, payload)

    // this.reportProcessTable = reportProcessTable
  }

  public async fetchReportGroups(organizationId: string, payload: IReportGroupPayload) {
    // this.reportGroups = await getReportGroups(organizationId, payload)
    // return this.reportGroups
  }

  public async fetchReportGroupTable(organizationId: string, payload: IReportGroupPayload) {
    // this.reportGroupsTable = await getReportGroupsTable(organizationId, payload)
    // return this.reportGroupsTable
  }

  public async getReportCollection(organizationId: string, payload: IReportCollectionPayload): Promise<void> {
    // const reportCollection = await getReportCollection(organizationId, payload)
    // this.reportCollection = reportCollection
  }

  public async getReportCollectionTable(organizationId: string, payload: IReportCollectionPayload): Promise<void> {
  ...
  public async fetchReportAction(organizationId: string, payload: IReportActionPayload): Promise<void> {
    // const reportAction = await getReportAction(organizationId, payload)
    // this.reportAction = reportAction
  }

  public async fetchReportActionTable(organizationId: string, payload: IReportActionPayload): Promise<void> {
    // const reportActionTable = await getReportActionTable(organizationId, payload)
    // this.reportActionTable = reportActionTable
  }

  public async fetchSummaryReport(organizationId: string, startDate: Date, endDate: Date): Promise<void> {
    await Promise.all([
  ...
  public async fetchReportProcessDetail(organizationId: string, processId: string, payload: IReportDetailPayload) {
    // const response = await getReportProcessDetail(organizationId, processId, payload)
    // this.reportDetail = response
  }

  public async fetchReportCollectionDetail(organizationId: string, id: string, payload: IReportDetailPayload) {
    // const response = await getReportCollectionDetail(organizationId, id, payload)
    // this.reportDetail = response
  }

  public async fetchReportGroupDetail(organizationId: string, groupId: string, payload: IReportDetailPayload) {
    // const response = await getReportGroupDetail(organizationId, groupId, payload)
    // this.reportDetail = response
  }

  public async fetchCompanyReport(payload: ICompanyReportPayload): Promise<void> {
    const response = await getCompanyReport(payload)
    this.companyReport = response
  }

  public async fetchCompanyReportTable(payload: ICompanyReportPayload): Promise<void> {
    const response = await getCompanyReportTable(payload)
    this.companyReportTable = response
  }

  public async fetchCompanyReportDetail(id: string, payload: IReportGeneralPayload): Promise<void> {
